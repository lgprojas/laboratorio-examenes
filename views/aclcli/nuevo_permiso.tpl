<div class="container">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{$_layoutParams.root}aclcli/permisos">Lista permisos</a></li>
...
<form name="form1" action="" method="post">
    ...
    <div class="col-md-4">
        ...
        <br/>
        <p><a class="btn btn-outline-info" href="{$_layoutParams.root}aclcli/permisos"><i title="Volver" class="bi bi-arrow-return-left"></i> Volver</a>   
