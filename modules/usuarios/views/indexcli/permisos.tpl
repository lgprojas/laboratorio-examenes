<div class="container">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Permisos usuario cliente</li>
    </ol>
    </nav>
        
<h3>Permisos de Usuario</h3>
<h5><strong>Cliente:</strong> {$info.Nom_usucli}<br /><strong>Rol:</strong> {$info.Nom_rolecli}</h5>
...
<form name="form1" method="post" action="">
    ...
    {if isset($permisos) && count($permisos)}
        ...
        <p><a class="btn btn-outline-info" href="{$_layoutParams.root}usuarios/indexcli/index/{$Idempresa_encrypt}"><i title="Volver" class="bi bi-arrow-return-left"></i> Volver</a>   <input class="btn btn-primary" type="submit" value="guardar"/></p>
        {/if}
</form>
</div>
</div>