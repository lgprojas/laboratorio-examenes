...
<form name="form1" method="post" action="">
    ...
    <div class="form-group col-lg-5 row">
     ...
     <a class="btn btn-outline-info" href="{$_layoutParams.root}usuarios/indexcli/index/{$Idempresa_encrypt}"><i title="Volver" class="bi bi-arrow-return-left"></i> Volver</a>
