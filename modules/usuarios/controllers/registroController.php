...
class registroController extends Controller{
    ...
    public function index($idempresa=false) {
        ...
        $this->_view->assign('emp', $this->_registro->getAllEmp($empresa));                       
        ...
        if($this->getInt('enviar') == 1){
            ...
            //enviar email activación cuenta colaborador
                ...
                $mail->Body = '
                            ...
                            <p style="box-sizing:border-box;font-weight:500;font-size:24px;line-height:32px;color:#232942;margin:34px 0 32px" align="center">Estimado(a) '.$dcli['Nom1_emp'].' '.$dcli['Ape1_emp'].' '.$dcli['Ape2_emp'].'</p>
                            ...
                            <p class="m_8758230702427326819paragraph-bold" style="box-sizing:border-box;font-weight:700;font-size:14px;line-height:22px;letter-spacing:0.25px;color:#4c516d;margin:32px 0" align="left">Creación de su usuario colaborador en nuestra plataforma.</p>
                            ...
                            <p style="box-sizing:border-box;margin:0"><span style="color:#222222;box-sizing:border-box">Estimado colaborador,</span></p>
                            ...
                            <p></p>
                            <p style="box-sizing:border-box;margin:0;text-align: center;"><span style="background-color:white;box-sizing:border-box"><span style="color:#222222;box-sizing:border-box"><a href="https://www.pruebajuridico.athel.cl/usuarios/registro/activarUsu/'.$idusu_encrypt.'/'.$codUsu.'" alt="Activar cuenta" target="_blank" rel="noopener noreferrer">Activar su cuenta de usuario aquí</a></span></span></p>
                            <p></p>
                            <p></p>
